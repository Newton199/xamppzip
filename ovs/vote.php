...
//governor
$result=mysqli_query($conn,"select * from candidate where CandidateID='$governor'")or die(mysqli_query());
$row=mysqli_fetch_array($result);
$name=$row['FirstName']."  ".$row['LastName'];
//
//vice-governor
$vice=mysqli_query($conn,"select * from candidate where CandidateID='$vice1'")or die(mysqli_query());
$row_vice=mysqli_fetch_array($vice);

$name1=$row_vice['FirstName']."  ".$row_vice['LastName'];
//
//Representative1
$Representative1=mysqli_query($conn,"select * from candidate where CandidateID='$representative1'")or die(mysqli_query());
$Representative1_row=mysqli_fetch_array($Representative1);

$name2=$Representative1_row['FirstName']."  ".$Representative1_row['LastName'];
//
//Representative2
$Representative2=mysqli_query($conn,"select * from candidate where CandidateID='$representative2'")or die(mysqli_query());
...
//Representative3
$Representative3=mysqli_query($conn,"select * from candidate where CandidateID='$representative3'")or die(mysqli_query());
