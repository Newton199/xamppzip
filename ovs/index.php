...
<body>
	...
	<div class="container">
		...
		<a class="brand">
		<img src="admin/images/tu.png" width="60" height="60">
 	</a>
	 <a class="brand">
	 <h2>Online Voting System</h2>
	 <div class="chmsc_nav"><font size="4" color="white">Kavre Multiple Campus</font></div>
 	</a>
...
$login_query=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' and Year='1st year'") or die(mysqli_error($conn));
$login_query3=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' and Year='2nd year'") or die(mysqli_error($conn));
$login_query4=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' and Year='3rd year'") or die(mysqli_error($conn));
$login_query5=mysqli_query($conn,"select * from voters where Username='$UserName' and Password='$Password' and Status='Unvoted' and Year='4th year'") or die(mysqli_error($conn));
//
