...
<div class="navbar">
	...
	<div id="element" class="hero-body">
	  <div class="thumbnail_gallery">
				...
				<div id="myGallery" class="spacegallery">
					...
					<img src="images/KMC6.jpg" alt="" />
					<img src="images/KMC5.jpg" alt="" />
					<img src="images/KMC4.jpg" alt="" />
					<img src="images/KMC3.png" alt="" />
					<img src="images/KMC1.jpg" alt="" />
					<img src="images/KMC.jpg" alt="" />
            </div>
			</div>
			  <div class="thumbnail_mission">
			  <h2>Mission</h2>
			  <p>This College serving as a ground for education students,seeks to develop in excellence
			  and with quality, the total personality of children and youth become worthy members of society.
			  </p>
	...
	<button type="button" class="close" data-dismiss="modal">�</button>
	  ...
	  <div class="modal-body">
	   <h2>KMC</h2>
<p><font color="black">
The college of education as a leading training center for globally competitive professional teachers in the secondary  and  Higher  secondary levels
</p>	  

	   <h2>KMC</h2>
<p><font color="black">
Vision Train and develop highly motivated and committed professional Higher Secondary and secondary teachers equipped with instructional,personal and social competencies conductive to the task of human development.
</p>	 
	  </div>
	  <div class="modal-footer">
	    <a href="#" class="btn" data-dismiss="modal">Close</a>
			   ...
			   <h2>Objectives</h2><p> Secondary and School Level</p>
			  <p>*develop an Enlightened commitment to the national ideals by cherishing,
			  preserving and developing the desirable aspects of Nepalese heritage, spiritually,
			  morally and socialy.
			  </p>
